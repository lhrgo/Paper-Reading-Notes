...
![原论文 Table 1：VGG 各配置结构表](./assets/vgg/vgg-paper-table-1-configurations.png)
...
![原论文 Table 6 / Table 7：VGG 融合结果与 SOTA 对比](./assets/vgg/vgg-paper-table-6-7-results.png)
...
到今天再回头看，VGG 也许已经不是最实用的网络了，但它依然是 CNN 发展史里绕不过去的一篇论文。因为它把“深度是有价值的”这件事，真正讲明白了。
